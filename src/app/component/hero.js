...
export default function Hero() {
  return (
    <>
    {/* mobile */}
      <section className="p-10 lg:p-20 bg-slate-400 rounded-md shadow-[-3px_5px_3px_rgba(0,0,0,0.3)] ">
        <div className="lg:flex items-center ml-8 lg:ml-20">
          {/* Kiri */}
          <div className="lg:w-1/2">
            <h1
              className={`${montserrat.className} text-3xl lg:text-5xl font-bold leading-tight mb-6`}
            >
              Cetak <span className="text-amber-400">Sablon Digital</span>{" "}
              Berkualitas untuk Bisnis & Kebutuhan Personal
            </h1>

            <p className="text-sm lg:text-xl text-gray-200 leading-relaxed mb-8">
            ...
            <a
              className="text-gray-200 italic px-4 py-2 rounded-xl border border-amber-400 hover:bg-amber-400 cursor-pointer transition delay-100"
              href="#"
            >
              Pesan Sekarang
            </a>
